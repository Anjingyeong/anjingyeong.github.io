...
- **해결 결과 (Result):** 기존 베이스라인 대비 mAP(평균 정밀도) 약 7%p 상승 및 상용 엣지(GPU) 환경에서 22 FPS 이상의 실시간 추론 성능을 안정적으로 확보하였습니다. (🏆 제17회 건양대학교 캡스톤디자인 경진대회 금상/대상 및 전국 공학교육혁신 컨소시엄 경진대회 동상 수상)
